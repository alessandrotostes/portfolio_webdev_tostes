              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 pb-4 border-b border-slate-800/60">
                  <div>
                    ...
                    <span className="text-sm font-semibold text-cyan-400">{company}</span>
                  </div>
                ...
                <div className="space-y-2 mb-6">
                  <span className="text-[11px] font-mono text-slate-400 uppercase tracking-wider block">{t.experience.deliveriesLabel}</span>
