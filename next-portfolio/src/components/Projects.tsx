...
export const Projects: React.FC = () => {
  ...
  const filterButtons = [
    ...
    { label: t.projects.filters.saas, value: 'saas' },
    { label: t.projects.filters.landing, value: 'landing' },
    { label: t.projects.filters.pwa, value: 'pwa' },
    { label: t.projects.filters.institucional, value: 'institucional' },
  ];
